# This code is borrowed from  D. Perale <https://github.com/DPerale/comparison-system-FPS-EDF/blob/master/python-taskset-generator/taskset_generator.py>

from random import randint
from perale_support_functions import UUnifast
...
task_hyper_113400000_10_100 = [94500, 94500, 94500, 94500, 94500, 94500, 94500, 94500, 94500, 94500, 94500, 94500,
                               94500, 94500, 94500, 45000, 45360, 47250, 50000, 50400, 52500, 54000, 56250, 56700,
...
def create_taskset_hyper_113400000_10_100(num_tasks, utilization, min_armonicity_grade, max_armonicity_grade):
    ...
    utilization_context_switch, utilization_clock, utilization_support_function = UUnifast(taskset, utilization)
    # print(perale_support_functions.calculate_hyperperiod(taskset))
    return taskset, utilization_context_switch, utilization_clock, utilization_support_function
