...
package body Taskset_E2_semi2WF_T260 is
begin
  ...
  T_9 : Low_Crit (Pri => 5, Low_Critical_Budget => 3.530238450753682, Is_Migrable => True, Workload => 0, Period => 40, CPU_Id => 2);
  T_0 : Low_Crit (Pri => 4, Low_Critical_Budget => 1.2790873096347877, Is_Migrable => False, Workload => 0, Period => 60, CPU_Id => 2);
