...
package body Taskset_E2_semi2WF_T652 is
begin
  ...
  T_0 : Low_Crit (Pri => 5, Low_Critical_Budget => 1.6030565104051009, Is_Migrable => True, Workload => 0, Period => 20, CPU_Id => 1);
  T_4 : Low_Crit (Pri => 2, Low_Critical_Budget => 4.268786240066911, Is_Migrable => False, Workload => 0, Period => 70, CPU_Id => 1);
