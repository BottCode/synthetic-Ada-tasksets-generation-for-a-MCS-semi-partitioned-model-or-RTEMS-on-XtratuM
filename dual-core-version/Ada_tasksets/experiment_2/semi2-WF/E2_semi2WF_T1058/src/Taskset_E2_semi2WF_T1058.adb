...
package body Taskset_E2_semi2WF_T1058 is
begin
  ...
  T_4 : Low_Crit (Pri => 4, Low_Critical_Budget => 6.862748021582725, Is_Migrable => True, Workload => 0, Period => 30, CPU_Id => 1);
  T_7 : Low_Crit (Pri => 3, Low_Critical_Budget => 8.10158905214869, Is_Migrable => False, Workload => 0, Period => 60, CPU_Id => 1);
