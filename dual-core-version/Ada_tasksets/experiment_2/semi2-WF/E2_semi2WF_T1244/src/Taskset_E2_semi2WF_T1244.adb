...
package body Taskset_E2_semi2WF_T1244 is
begin
  ...
  T_6 : Low_Crit (Pri => 5, Low_Critical_Budget => 41.338447964693074, Is_Migrable => True, Workload => 0, Period => 120, CPU_Id => 1);
  T_8 : Low_Crit (Pri => 1, Low_Critical_Budget => 47.33606049192301, Is_Migrable => False, Workload => 0, Period => 400, CPU_Id => 1);
  T_1 : Low_Crit (Pri => 4, Low_Critical_Budget => 20.288358700346883, Is_Migrable => False, Workload => 0, Period => 180, CPU_Id => 1);
