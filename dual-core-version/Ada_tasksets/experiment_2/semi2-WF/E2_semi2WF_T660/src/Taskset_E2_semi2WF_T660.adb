...
package body Taskset_E2_semi2WF_T660 is
begin
  ...
  T_1 : Low_Crit (Pri => 5, Low_Critical_Budget => 1.5168869548566488, Is_Migrable => True, Workload => 0, Period => 10, CPU_Id => 1);
  T_10 : Low_Crit (Pri => 4, Low_Critical_Budget => 2.0929098490284006, Is_Migrable => False, Workload => 0, Period => 30, CPU_Id => 1);
