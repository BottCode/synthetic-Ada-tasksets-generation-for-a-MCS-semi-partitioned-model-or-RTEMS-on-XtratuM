...
package body Taskset_E2_semi2WF_T655 is
begin
  ...
  T_8 : Low_Crit (Pri => 2, Low_Critical_Budget => 6.28840887449309, Is_Migrable => False, Workload => 0, Period => 120, CPU_Id => 1);
  ...
  T_5 : High_Crit (Pri => 4, Low_Critical_Budget => 0.4852988131801501, High_Critical_Budget => 1.2132470329503753, Workload => 0, Period => 30, CPU_Id => 2);
  T_4 : Low_Crit (Pri => 5, Low_Critical_Budget => 11.31496873328696, Is_Migrable => False, Workload => 0, Period => 30, CPU_Id => 2);
  T_2 : Low_Crit (Pri => 6, Low_Critical_Budget => 1.6997960256542144, Is_Migrable => True, Workload => 0, Period => 10, CPU_Id => 2);
  T_6 : Low_Crit (Pri => 3, Low_Critical_Budget => 15.656148738976265, Is_Migrable => False, Workload => 0, Period => 140, CPU_Id => 2);
