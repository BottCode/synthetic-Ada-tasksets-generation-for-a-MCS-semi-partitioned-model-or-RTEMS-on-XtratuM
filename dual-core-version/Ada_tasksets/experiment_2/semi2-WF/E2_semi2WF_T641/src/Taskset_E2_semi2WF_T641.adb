...
package body Taskset_E2_semi2WF_T641 is
begin
  ...
  T_11 : Low_Crit (Pri => 4, Low_Critical_Budget => 2.3057869644764053, Is_Migrable => True, Workload => 0, Period => 10, CPU_Id => 2);
  T_3 : Low_Crit (Pri => 2, Low_Critical_Budget => 35.86112284299841, Is_Migrable => False, Workload => 0, Period => 180, CPU_Id => 2);
