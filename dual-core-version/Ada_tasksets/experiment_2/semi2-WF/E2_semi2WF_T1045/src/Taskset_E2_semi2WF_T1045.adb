...
package body Taskset_E2_semi2WF_T1045 is
begin
  ...
  T_2 : High_Crit (Pri => 3, Low_Critical_Budget => 0.15039376610144523, High_Critical_Budget => 0.5263781813550583, Workload => 0, Period => 10, CPU_Id => 1);
  T_11 : Low_Crit (Pri => 1, Low_Critical_Budget => 25.48424340674447, Is_Migrable => False, Workload => 0, Period => 90, CPU_Id => 1);
  T_1 : Low_Crit (Pri => 2, Low_Critical_Budget => 15.427747157757528, Is_Migrable => False, Workload => 0, Period => 70, CPU_Id => 1);
  ...
  T_4 : Low_Crit (Pri => 7, Low_Critical_Budget => 5.136408418295202, Is_Migrable => True, Workload => 0, Period => 50, CPU_Id => 2);
  T_9 : Low_Crit (Pri => 4, Low_Critical_Budget => 28.748798960717775, Is_Migrable => False, Workload => 0, Period => 310, CPU_Id => 2);
  T_8 : Low_Crit (Pri => 6, Low_Critical_Budget => 8.129565344413848, Is_Migrable => False, Workload => 0, Period => 150, CPU_Id => 2);

end E2_semi2WF_T1045;
