...
package body Taskset_E2_semi2WF_T848 is
begin
  ...
  T_2 : Low_Crit (Pri => 3, Low_Critical_Budget => 9.582839748477632, Is_Migrable => True, Workload => 0, Period => 80, CPU_Id => 1);
  T_5 : Low_Crit (Pri => 2, Low_Critical_Budget => 20.526775274247335, Is_Migrable => False, Workload => 0, Period => 200, CPU_Id => 1);
