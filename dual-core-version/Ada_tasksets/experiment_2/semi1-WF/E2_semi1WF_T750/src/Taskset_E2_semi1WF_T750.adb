...
package body Taskset_E2_semi1WF_T750 is
begin
  ...
  T_6 : Low_Crit (Pri => 4, Low_Critical_Budget => 2.758514734217524, Is_Migrable => False, Workload => 0, Period => 10, CPU_Id => 2);
  T_7 : Low_Crit (Pri => 3, Low_Critical_Budget => 4.681153611434885, Is_Migrable => True, Workload => 0, Period => 20, CPU_Id => 2);
