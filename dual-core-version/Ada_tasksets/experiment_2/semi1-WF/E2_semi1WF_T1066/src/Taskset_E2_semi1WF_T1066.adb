...
package body Taskset_E2_semi1WF_T1066 is
begin
  ...
  T_8 : Low_Crit (Pri => 6, Low_Critical_Budget => 2.5039044749260713, Is_Migrable => False, Workload => 0, Period => 10, CPU_Id => 1);
  T_1 : Low_Crit (Pri => 5, Low_Critical_Budget => 3.645734275916106, Is_Migrable => False, Workload => 0, Period => 20, CPU_Id => 1);
  T_6 : Low_Crit (Pri => 3, Low_Critical_Budget => 17.57350143759451, Is_Migrable => True, Workload => 0, Period => 100, CPU_Id => 1);
