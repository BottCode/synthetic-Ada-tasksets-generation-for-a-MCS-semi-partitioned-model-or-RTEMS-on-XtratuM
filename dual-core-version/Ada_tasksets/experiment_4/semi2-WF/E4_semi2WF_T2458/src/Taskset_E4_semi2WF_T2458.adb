...
package body Taskset_E4_semi2WF_T2458 is
begin
  ...
  T_10 : Low_Crit (Pri => 8, Low_Critical_Budget => 0.9356309313248962, Is_Migrable => True, Workload => 0, Period => 10, CPU_Id => 2);
  T_11 : Low_Crit (Pri => 6, Low_Critical_Budget => 1.2430545754752578, Is_Migrable => False, Workload => 0, Period => 30, CPU_Id => 2);
  T_6 : Low_Crit (Pri => 7, Low_Critical_Budget => 1.0642080968045375, Is_Migrable => False, Workload => 0, Period => 30, CPU_Id => 2);
  T_1 : Low_Crit (Pri => 5, Low_Critical_Budget => 2.0606853788177837, Is_Migrable => False, Workload => 0, Period => 80, CPU_Id => 2);

end E4_semi2WF_T2458;
