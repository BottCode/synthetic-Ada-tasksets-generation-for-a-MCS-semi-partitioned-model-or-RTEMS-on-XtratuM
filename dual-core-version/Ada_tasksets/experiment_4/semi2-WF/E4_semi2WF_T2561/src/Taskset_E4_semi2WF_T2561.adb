...
package body Taskset_E4_semi2WF_T2561 is
begin
  ...
  T_4 : Low_Crit (Pri => 7, Low_Critical_Budget => 1.4292854070692562, Is_Migrable => True, Workload => 0, Period => 10, CPU_Id => 1);
  ...
  T_14 : Low_Crit (Pri => 5, Low_Critical_Budget => 7.727185377832566, Is_Migrable => False, Workload => 0, Period => 120, CPU_Id => 1);
