...
package taskset_e1_semi1wf_t57 is
  ...
  T_0 : Low_Crit (Pri => 4, Low_Critical_Budget => 1, Is_Migrable => False, Workload => 1, Period => 60, CPU_Id => 1);
  T_4 : Low_Crit (Pri => 0, Low_Critical_Budget => 1, Is_Migrable => True, Workload => 1, Period => 870, CPU_Id => 1);
