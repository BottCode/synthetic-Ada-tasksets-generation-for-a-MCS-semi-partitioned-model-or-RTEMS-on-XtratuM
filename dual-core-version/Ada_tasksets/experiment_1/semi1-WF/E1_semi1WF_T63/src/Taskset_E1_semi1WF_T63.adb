...
package body Taskset_E1_semi1WF_T63 is
begin
  ...
  T_2 : Low_Crit (Pri => 3, Low_Critical_Budget => 0.8301365742355804, Is_Migrable => False, Workload => 0, Period => 10, CPU_Id => 1);
  T_11 : Low_Crit (Pri => 0, Low_Critical_Budget => 30.759139518661893, Is_Migrable => True, Workload => 0, Period => 720, CPU_Id => 1);
